...
Я, (GH:Yasherke, DS:nre500), как автор оригинального кода в данном репозитории, заявляю что запрещаю использование механик или их копирование в каком либо виде.
